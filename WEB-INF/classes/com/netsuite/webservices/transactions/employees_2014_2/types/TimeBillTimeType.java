...
package com.netsuite.webservices.transactions.employees_2014_2.types;
...
public class TimeBillTimeType implements java.io.Serializable {
    ...
    public static final java.lang.String __allocatedTime = "_allocatedTime";
    ...
    public static final TimeBillTimeType _allocatedTime = new TimeBillTimeType(__allocatedTime);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.employees_2014_2.transactions.webservices.netsuite.com", "TimeBillTimeType"));
    }
    /**
