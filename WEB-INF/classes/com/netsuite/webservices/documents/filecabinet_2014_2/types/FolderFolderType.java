...
package com.netsuite.webservices.documents.filecabinet_2014_2.types;
...
public class FolderFolderType implements java.io.Serializable {
    ...
    public static final java.lang.String __attachmentsToSend = "_attachmentsToSend";
    ...
    public static final FolderFolderType _attachmentsToSend = new FolderFolderType(__attachmentsToSend);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.filecabinet_2014_2.documents.webservices.netsuite.com", "FolderFolderType"));
    }
    /**
