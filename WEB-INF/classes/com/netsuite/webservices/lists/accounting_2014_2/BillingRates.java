...
public class BillingRates  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2014_2.Rate[] rateList;
    ...
    public BillingRates(
           ...
           com.netsuite.webservices.lists.accounting_2014_2.Rate[] rateList) {
     ...
     * @return rateList
     */
    public com.netsuite.webservices.lists.accounting_2014_2.Rate[] getRateList() {
        return rateList;
    }
     ...
     * @param rateList
     */
    public void setRateList(com.netsuite.webservices.lists.accounting_2014_2.Rate[] rateList) {
        this.rateList = rateList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2014_2.lists.webservices.netsuite.com", "BillingRates"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2014_2.lists.webservices.netsuite.com", "billingClass"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2014_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2014_2.lists.webservices.netsuite.com", "rateList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2014_2.lists.webservices.netsuite.com", "Rate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:accounting_2014_2.lists.webservices.netsuite.com", "rate"));
        typeDesc.addFieldDesc(elemField);
    }
