...
public class EmployeePayFrequency implements java.io.Serializable {
    ...
    public static final EmployeePayFrequency _hourly = new EmployeePayFrequency(__hourly);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.employees_2014_2.lists.webservices.netsuite.com", "EmployeePayFrequency"));
    }
    /**
