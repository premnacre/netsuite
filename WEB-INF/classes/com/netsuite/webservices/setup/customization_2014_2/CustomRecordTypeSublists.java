...
public class CustomRecordTypeSublists  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2014_2.RecordRef recordSearch;

    private java.lang.String recordDescr;

    private com.netsuite.webservices.setup.customization_2014_2.LanguageValue[] recordDescrLanguageValueList;

    private com.netsuite.webservices.platform.core_2014_2.RecordRef recordTab;
    ...
    public CustomRecordTypeSublists(
           com.netsuite.webservices.platform.core_2014_2.RecordRef recordSearch,
           java.lang.String recordDescr,
           com.netsuite.webservices.setup.customization_2014_2.LanguageValue[] recordDescrLanguageValueList,
           com.netsuite.webservices.platform.core_2014_2.RecordRef recordTab,
     ...
     * @return recordSearch
     */
    public com.netsuite.webservices.platform.core_2014_2.RecordRef getRecordSearch() {
        return recordSearch;
    }
     ...
     * @param recordSearch
     */
    public void setRecordSearch(com.netsuite.webservices.platform.core_2014_2.RecordRef recordSearch) {
        this.recordSearch = recordSearch;
    }
     ...
     */
    public com.netsuite.webservices.setup.customization_2014_2.LanguageValue[] getRecordDescrLanguageValueList() {
        return recordDescrLanguageValueList;
    }
     ...
     */
    public void setRecordDescrLanguageValueList(com.netsuite.webservices.setup.customization_2014_2.LanguageValue[] recordDescrLanguageValueList) {
        this.recordDescrLanguageValueList = recordDescrLanguageValueList;
    }
     ...
     * @return recordTab
     */
    public com.netsuite.webservices.platform.core_2014_2.RecordRef getRecordTab() {
        return recordTab;
    }
     ...
     * @param recordTab
     */
    public void setRecordTab(com.netsuite.webservices.platform.core_2014_2.RecordRef recordTab) {
        this.recordTab = recordTab;
    }
        ...
        _equals = true && 
            ...
            ((this.recordDescrLanguageValueList==null && other.getRecordDescrLanguageValueList()==null) || 
             (this.recordDescrLanguageValueList!=null &&
              java.util.Arrays.equals(this.recordDescrLanguageValueList, other.getRecordDescrLanguageValueList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getRecordDescrLanguageValueList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getRecordDescrLanguageValueList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getRecordDescrLanguageValueList(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "CustomRecordTypeSublists"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recordSearch");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "recordSearch"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "recordDescr"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "recordDescrLanguageValueList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "LanguageValue"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "languageValue"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recordTab");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "recordTab"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2014_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2014_2.setup.webservices.netsuite.com", "recordId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
