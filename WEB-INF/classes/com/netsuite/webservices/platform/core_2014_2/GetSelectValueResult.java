...
public class GetSelectValueResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2014_2.BaseRef[] baseRefList;
    ...
    public GetSelectValueResult(
           ...
           com.netsuite.webservices.platform.core_2014_2.BaseRef[] baseRefList) {
           this.status = status;
     ...
     * @return baseRefList
     */
    public com.netsuite.webservices.platform.core_2014_2.BaseRef[] getBaseRefList() {
        return baseRefList;
    }
     ...
     * @param baseRefList
     */
    public void setBaseRefList(com.netsuite.webservices.platform.core_2014_2.BaseRef[] baseRefList) {
        this.baseRefList = baseRefList;
    }
        ...
        _equals = true && 
            ...
            ((this.baseRefList==null && other.getBaseRefList()==null) || 
             (this.baseRefList!=null &&
              java.util.Arrays.equals(this.baseRefList, other.getBaseRefList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getBaseRefList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBaseRefList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getBaseRefList(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2014_2.platform.webservices.netsuite.com", "GetSelectValueResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2014_2.platform.webservices.netsuite.com", "baseRefList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2014_2.platform.webservices.netsuite.com", "BaseRefList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
