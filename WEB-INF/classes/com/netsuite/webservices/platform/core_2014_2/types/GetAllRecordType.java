...
public class GetAllRecordType implements java.io.Serializable {
    ...
    public static final GetAllRecordType costCategory = new GetAllRecordType(_costCategory);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2014_2.platform.webservices.netsuite.com", "GetAllRecordType"));
    }
    /**
