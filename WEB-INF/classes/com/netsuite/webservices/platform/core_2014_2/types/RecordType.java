...
public class RecordType implements java.io.Serializable {
    ...
    public static final RecordType appDefinition = new RecordType(_appDefinition);
    public static final RecordType appPackage = new RecordType(_appPackage);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2014_2.platform.webservices.netsuite.com", "RecordType"));
    }
    /**
