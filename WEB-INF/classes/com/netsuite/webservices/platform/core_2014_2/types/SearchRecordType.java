...
package com.netsuite.webservices.platform.core_2014_2.types;
...
public class SearchRecordType implements java.io.Serializable {
    ...
    public static final java.lang.String _appDefinition = "appDefinition";
    public static final java.lang.String _appPackage = "appPackage";
    ...
    public static final SearchRecordType appDefinition = new SearchRecordType(_appDefinition);
    public static final SearchRecordType appPackage = new SearchRecordType(_appPackage);
    public static final SearchRecordType assemblyItem = new SearchRecordType(_assemblyItem);
    ...
    public static final SearchRecordType lotNumberedAssemblyItem = new SearchRecordType(_lotNumberedAssemblyItem);
    ...
    public static final SearchRecordType serializedAssemblyItem = new SearchRecordType(_serializedAssemblyItem);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2014_2.platform.webservices.netsuite.com", "SearchRecordType"));
    }
    /**
